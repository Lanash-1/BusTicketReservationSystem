...
import com.example.busticketreservationsystem.databinding.FragmentCancelledBookingBinding
...
//        return inflater.inflate(R.layout.fragment_cancelled_booking, container, false)
        binding = FragmentCancelledBookingBinding.inflate(inflater, container, false)
        return binding.root
    }
